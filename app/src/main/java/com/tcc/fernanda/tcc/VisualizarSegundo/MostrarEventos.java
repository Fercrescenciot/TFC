...
import com.tcc.fernanda.tcc.Cadastro.CadastrarEventos;
...
public class MostrarEventos extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(extra != null){
        String textopassado = extra.getString("");
        ...
        */
        ...
        btnVoltar = findViewById(R.id.btnVoltarEvento);
        btnCadastrarEvento =findViewById(R.id.btnCadastrarEventos);
